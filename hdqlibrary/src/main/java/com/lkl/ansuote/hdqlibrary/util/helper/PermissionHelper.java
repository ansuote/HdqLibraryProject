...
public class PermissionHelper {
    ...
    public static void requestStorage(final OnPermissionGrantedListener listener, final OnPermissionDeniedListener permissionDeniedListener) {
        request(listener, permissionDeniedListener, PermissionConstants.STORAGE);
    }
